...
const Hero = () => {
  return (
      <div className=" flex-col justify-center min-h-screen md:min-h-[80vh] max-w-[1200px] mx-auto grid md:grid-cols-8 gap-6 p-5 mb-5 md:px-5 md:pt-5 md:mb-5 h-full" id="home">
      <motion.div 
        ...
        <div className="my-auto md:ml-6 ml-2 flex-col text-gray-200">
          ...
          <p className="hidden text-lg md:text:2xl text-gray-400 font-semibold mt-2 sm:">with 0 year of experience :D.</p>
          <button className="mt-4 px-2 py-1 text-xs sm:px-4 sm:py-2 sm:text-sm font-bold text-gray-200 bg-primary-color rounded-lg ">Download CV  💌</button>
          <button className="mt-4 lg:ml-3 px-2 py-1 text-xs sm:px-4 sm:py-2 sm:text-sm  font-bold text-gray-200 bg-zinc-800 rounded-lg hover:bg-slate-600 transition duration-300">
